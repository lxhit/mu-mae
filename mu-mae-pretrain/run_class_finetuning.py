...
def get_args():
    parser = argparse.ArgumentParser('Mu-MAE fine-tuning and evaluation script for video classification', add_help=False)
    ...
    parser.add_argument('--data_set', default='Kinetics-400', choices=['mmact','Kinetics-400', 'SSV2', 'UCF101', 'HMDB51','image_folder'],
